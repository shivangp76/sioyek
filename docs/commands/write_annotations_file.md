...
Alternatively you can set the @config(annotations_directory) config to a directory path and the annotations file will be written there instead of next to the current file.