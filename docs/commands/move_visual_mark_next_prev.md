...
A red mark highlights the leftmost part of the next ruler position, so when you reach the red mark you can run @command(move_ruler_next) and continue reading from the left side of the screen.