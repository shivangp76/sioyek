...
doc_body:
Displays a tag next to each word in the document, jumps to the selected tag's word (this works even for documents that don't have links, otherwise @command(overview_link) would be used).