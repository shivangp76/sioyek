...
FulltextSearchWidget::FulltextSearchWidget(DatabaseManager* manager, QAbstractItemView* view, QAbstractItemModel* model, MainWidget* parent) 
...
FulltextSearchWidget* FulltextSearchWidget::create(MainWidget* parent) {
    ...
    FulltextSearchWidget* fulltext_search_widget = new FulltextSearchWidget(parent->db_manager, list_view, res_model, parent);
